...
def train(num_epochs: int,
    ...
    val_dataset = Peptide_struct_dataset(root=root,
                                          split='val')
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for i in loop:
            ...
            loss = nn.SmoothL1Loss()(pred, label.squeeze(dim=1))
        ...
        with torch.no_grad():
            ...
            print('Val MAE: %.5f, Test MAE: %.5f'% (val_loss, test_loss))
            print('Best_epoch: %i, Best Val MAE: %.5f, Best Test MAE: %f'% (best_epoch, best_val_loss, best_test_loss))
