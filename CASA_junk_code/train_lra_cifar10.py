...
def train(num_epochs: int,
    ...
    data_path = "./datasets/LRA/"
    train_dataset = CIFAR10Dataset(split='train', path_folder=data_path)
    test_dataset = CIFAR10Dataset(split='test', path_folder=data_path)
    ...
    model = parse_lra_architecture(model_str)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        with torch.no_grad():
            ...
            test_class_acc[:, 2] =  test_class_acc[:, 0] / (test_class_acc[:, 1] + 1e-9)
