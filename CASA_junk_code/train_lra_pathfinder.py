...
from data.dataset import PathFinderDataset
import warnings
...
def train(num_epochs: int,
    ...
    train_dataset = PathFinderDataset(split='train', path_folder=data_path)
    test_dataset = PathFinderDataset(split='test', path_folder=data_path)
