...
class CMultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, d_q, d_k_top, d_k_bot, d_k_score, relative_top, relative_bottom):
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, d_q, relative_map, mask=None):
        ...
        out, attention = self.att(q, k, v, d_q, d_k_top, d_k_bottom, x_score, relative_top, relative_bottom)
        return out, attention